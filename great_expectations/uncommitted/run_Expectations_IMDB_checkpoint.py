...
Usage:
- Run this file: `python great_expectations/uncommitted/run_Expectations_IMDB_checkpoint.py`.
...
data_context = DataContext(context_root_dir="/home/alex/SentimentAnalysis-TAED/great_expectations")

result: CheckpointResult = data_context.run_checkpoint(
    checkpoint_name="Expectations_IMDB_checkpoint",
    batch_request=None,
    run_name=None,
)
